...
export const FormalityChart: React.FC<ChartProps> = ({ data }) => {
  ...
  const chartConfig = {
    ...
    title: {
      text: 'Distribuição da quantidade de vídeos por nível de formalidade',
    },
    xAxis: {
      categories: minutes,
      title: {
        text: 'Nível da métrica formalidade',
      },
    },
    yAxis: {
      title: {
