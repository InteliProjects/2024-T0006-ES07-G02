...
export const MetaphorChart: React.FC<ChartProps> = ({ data }) => {
  ...
  const chartConfig = {
    ...
    title: {
      text: 'Distribuição da quantidade de vídeos por nível de uso de metáforas',
    },
    xAxis: {
      categories: minutes,
      title: {
        text: 'Nível da métrica metáforas',
      },
    },
    yAxis: {
      title: {
