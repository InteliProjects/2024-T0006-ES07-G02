...
export const InterationChart: React.FC<ChartProps> = ({ data }) => {
  ...
  const chartConfig = {
    ...
    title: {
      text: 'Distribuição da quantidade de vídeos por nível de interações',
    },
    xAxis: {
      categories: minutes,
      title: {
        text: 'Nível da métrica interações',
      },
    },
    yAxis: {
      title: {
...
export default InterationChart;
